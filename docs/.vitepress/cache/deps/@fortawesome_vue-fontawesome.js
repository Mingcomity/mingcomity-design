import { computed, defineComponent, h, watch } from './chunk-24SVQK3Z.js'
import { config$1, icon, parse$1, text } from './chunk-AGEN2LZX.js'

// ../node_modules/.pnpm/@fortawesome+vue-fontawesome@3.0.6_@fortawesome+fontawesome-svg-core@6.5.2_vue@3.4.21/node_modules/@fortawesome/vue-fontawesome/index.es.js
...
function classList(props) {
  ...
  var classes =
    ...
    _defineProperty(_classes, 'fa-rotate-'.concat(props.rotation), props.rotation !== null),
    _defineProperty(_classes, 'fa-pull-'.concat(props.pull), props.pull !== null),
  ...
  setup: function setup(props, _ref) {
    ...
    var transform = computed(function () {
      return objectWithKey(
        'transform',
        typeof props.transform === 'string' ? parse$1.transform(props.transform) : props.transform
      )
    })
  ...
  setup: function setup2(props, _ref) {
    ...
    var className = computed(function () {
      return [''.concat(familyPrefix, '-layers')].concat(
        _toConsumableArray(props.fixedWidth ? [''.concat(familyPrefix, '-fw')] : [])
      )
    })
    return function () {
      return h(
    ...
    var classes = computed(function () {
      return objectWithKey(
        ...
        [].concat(
          ...
          _toConsumableArray(
            props.position ? [''.concat(familyPrefix, '-layers-').concat(props.position)] : []
          )
        )
      )
    })
